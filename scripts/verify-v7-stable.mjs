...
const checks = [
  ...
  ['V7 final stable status', version.includes('V7.0 Finance Stable') && !version.includes('Release Candidate')],
  ['V7 final release milestone', version.includes('release: mark v7 finance stable')],
  ['V7 release candidate document exists', existsSync('docs/V7_FINANCE_STABLE_RC.md')],
  ['V7 release candidate document marked approved', existsSync('docs/V7_FINANCE_STABLE_RC.md') && read('docs/V7_FINANCE_STABLE_RC.md').includes('Release Candidate approved for V7.0 Finance Stable')],
  ['V7 final stable cache key', sw.includes("const CACHE='momentum-hub-v7-finance-stable-final'")],

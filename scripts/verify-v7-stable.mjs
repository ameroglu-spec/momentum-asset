...
const checks = [
  ...
  ['V7 RC build milestone', version.includes('release: build v7 finance stable candidate')],
  ['V7 release candidate document exists', existsSync('docs/V7_FINANCE_STABLE_RC.md')],
  ['V7 release candidate document marked ready', existsSync('docs/V7_FINANCE_STABLE_RC.md') && read('docs/V7_FINANCE_STABLE_RC.md').includes('Release Candidate ready for production validation')],
  ['V7 stable RC cache key', sw.includes("const CACHE='momentum-hub-v7-finance-stable-rc1'")],
